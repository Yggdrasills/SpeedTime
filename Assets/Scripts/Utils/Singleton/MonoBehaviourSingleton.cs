/*
 * Taken from here: https://gist.github.com/rickyah/271e3aa31ff8079365bc
 */

using System;
using UnityEngine;

namespace BaseCore.Utils.Singleton
{
    /// <summary>
    ...
    public class MonoBehaviourSingleton<T> : MonoBehaviour where T : MonoBehaviour
    {
        ...
        {
            GameObject containerGO = new GameObject("__" + typeof(T).Name + " (Singleton)");
